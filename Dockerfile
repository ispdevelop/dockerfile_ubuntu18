...
RUN apt-get -y update \
	...
	&& apt-get -y install libcurl4-openssl-dev libexpat1-dev nkf zsh ant libjpeg-dev vim language-pack-ja-base language-pack-ja ibus-mozc wget valgrind \
	...
	# gcc101
 	&& mkdir /root/tmp \
	&& cd /root/tmp \
	&& wget https://gcc-10-1-0.s3-ap-northeast-1.amazonaws.com/gcc_10_1_0_ubuntu18.tar.gz \
	&& tar zxvf gcc_10_1_0_ubuntu18.tar.gz -C /usr/local \
